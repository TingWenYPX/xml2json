...
public class XmlToJson {
    ...
    public static class Builder {
         ...
         */
        public Builder(@NotNull String xmlSource) {
         ...
         */
        public Builder(@NotNull InputStream inputStreamSource, @Nullable String inputEncoding) {
         ...
         * @return the Builder
         */
        public Builder forceList(@NotNull String path) {
         ...
         * @return the Builder
         */
        public Builder setAttributeName(@NotNull String attributePath, @NotNull String replacementName) {
         ...
         * @return the Builder
         */
        public Builder setContentName(@NotNull String contentPath, @NotNull String replacementName) {
         ...
         * @return the Builder
         */
        public Builder forceIntegerForPath(@NotNull String path) {
         ...
         * @return the Builder
         */
        public Builder forceLongForPath(@NotNull String path) {
         ...
         * @return the Builder
         */
        public Builder forceDoubleForPath(@NotNull String path) {
         ...
         * @return the Builder
         */
        public Builder forceBooleanForPath(@NotNull String path) {
         ...
         * @return the Builder
         */
        public Builder skipTag(@NotNull String path) {
         ...
         * @return the Builder
         */
        public Builder skipAttribute(@NotNull String path) {
        ...
        try {
            ...
            do {
                ...
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    System.out.println(TAG + "unknown xml eventType " + eventType);
                }
