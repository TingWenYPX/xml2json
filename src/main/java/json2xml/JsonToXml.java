...
public class JsonToXml {
    ...
    public static class Builder {
         ...
         */
        public Builder(@NotNull InputStream inputStream) {
        ...
        public Builder(String jsonString) {
            try {
                mJson = JSON.parseObject(jsonString);
    ...
    private JsonToXml(@NotNull JSONObject jsonObject, @NotNull HashSet<String> forcedAttributes, HashSet<String> forcedContent) {
        mJson = jsonObject;
    ...
    private void prepareObject(Node node, JSONObject json) {
        Iterator<String> keyterator = json.keySet().iterator();
